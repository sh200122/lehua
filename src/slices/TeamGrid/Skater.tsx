    ...
    <div className="skater group relative flex flex-col items-center gap-4">
      <div className="stack-layout overflow-hidden">
        <PrismicNextImage
          ...
          width={500}
          imgixParams={{ q: 20 }}
          className="scale-110 transition-all duration-1000 ease-in-out group-hover:scale-100 group-hover:brightness-75 group-hover:saturate-[.8]"
        />
        ...
        />
        <div
          className="relative h-48 w-full place-self-end bg-gradient-to-t from-black via-transparent
        to-transparent"
        ></div>
        <h3 className="relative grid place-self-end justify-self-start p-2 font-sans text-brand-gray -text-2xl/3xl">
          <span className="mb-[-.3rem] block">{skater.data.first_name}</span>
